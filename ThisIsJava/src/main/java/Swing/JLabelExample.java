...
public class JLabelExample extends JFrame{
	...
	public JLabel getJLabel2() {
		...
		if(jLabel2 == null) {
			...
			jLabel2.setIcon(new ImageIcon(getClass().getResource("game.png")));
	...
	public JLabel getJLabel3() {
		...
		if(jLabel3 == null) {
			...
			jLabel3.setIcon(new ImageIcon(getClass().getResource("new.gif")));
	...
	public JLabel getJLabel4() {
		...
		if(jLabel4 == null) {
			...
			jLabel4.setIcon(new ImageIcon(getClass().getResource("snow.jpg")));
