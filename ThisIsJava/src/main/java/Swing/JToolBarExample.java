...
public class JToolBarExample extends JFrame{
	...
	public JButton getBtnSave() {
		...
		if(btnSave == null) {
			btnSave = new JButton();
			btnSave.setIcon(new ImageIcon(getClass().getResource("game.png")));
	...
	public JButton getBtnCopy() {
		...
		if(btnCopy == null) {
			btnCopy = new JButton();
			btnCopy.setIcon(new ImageIcon(getClass().getResource("snow.jpg")));
	...
	public JButton getBtnPaste() {
		...
		if(btnPaste == null) {
			...
			btnPaste.setIcon(new ImageIcon(getClass().getResource("snow.jpg")));
